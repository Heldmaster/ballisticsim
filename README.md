...
***UPD: PyQT, однозначно. Хоть у DPG изначально очень красивый дизайн, но у QT есть один очень существенный плюс - он из коробки работает с OpenGL. И там прям вообще прикольно: плотная связка QT+OpenGL, быстро работает, туториалов много. Ну а с дизайном что-нибудь придумаем, CSS тему скачаем или еще что-то.***
